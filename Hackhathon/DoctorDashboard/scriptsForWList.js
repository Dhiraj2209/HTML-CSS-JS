...
const totalAppointmentsinq = appointments.filter(appointment => appointment.age === 'all').length;
document.getElementById('totalAppointmentsCountinQueue').textContent = totalAppointmentsinq;